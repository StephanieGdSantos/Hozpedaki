...
<body>
    ...
    <div class="form-register">
        ...
        <form action="../../routes/routes.php" method="post">
            <input type="text" name="action" value="edit-register">
            <div style="display: grid; grid-template-columns: 1fr 1fr; align-items: end; gap: 160px;">
                <div class="side-form">
                    ...
                    <div class="title-input">
                        ...
                        <input class="no-mutable" type="date" name="birth" value="" readonly>
                    </div>
                </div>
                <div class="side-form">
                    ...
                    <div class="title-input">
                        <label>Senha: </label>
                        <input class="no-mutable" type="password" name="password" value="" readonly>
                    </div>

                    <div class="title-input">
                        <label>Usuário: </label>
                        <input class="no-mutable" type="text" name="userType" value="" readonly>
                    </div>
                </div>
            </div>
